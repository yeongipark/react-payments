...
const StyledContainer$8 = dt.div.withConfig({
...
function getIdentifyFns(id) {
  return [
    ...
    {
      identify: () => Number(id) >= CARD_IDENTIFYING_NUMBER.MASTERCARD.MIN && Number(id) <= CARD_IDENTIFYING_NUMBER.MASTERCARD.MAX,
      logoSrc: "./images/Mastercard.svg"
    }
  ];
}
function useLogoSrc(cardNumber) {
  const logoSrc = reactExports.useMemo(() => {
    ...
    return (identifiedLogoSrc == null ? void 0 : identifiedLogoSrc.logoSrc) ?? INITIALIZE_VALUE;
  }, [cardNumber]);
  return { logoSrc };
}
...
const StyledContainer$7 = dt.div`
  display: flex;
  flex-direction: column;
...
const CARD_NUMBER_POSITION = {
  FIRST: "first",
  SECOND: "second",
  THIRD: "third",
  FOURTH: "fourth"
};
const StyledContainer$6 = dt.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
function useAutoFocus({
  ...
  reactExports.useEffect(() => {
    var _a;
    (_a = inputRefs[0].current) == null ? void 0 : _a.focus();
  }, []);
  const handleAutoFocus = (event, index) => {
    var _a;
    if (event.currentTarget.value.length >= inputMaxLength && index < inputCount - 1) {
...
function CardNumberInputs({ cardNumber, cardNumberError }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$6, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "", children: "카드 번호" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledInputWrap, { children: cardInputConfig.map((position2, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRefs[idx],
...
const StyledContainer$5 = dt.div`
  ...
  gap: 16px;
`;
function CardNumberSection({ cardNumber, cardNumberError }) {
...
function Select({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledSelect, { width, value, onChange, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledOption, { value: "", disabled: true, children: placeholder }),
    options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(StyledOption, { value: option.value, children: option.label }, option.value))
  ] });
}
const CARD_TYPES = {
  BC카드: "BC카드",
...
const StyledContainer$2 = dt.div`
  ...
  width: 100%;
`;
function CardTypeSection({ cardType }) {
  const options = [
...
function CardPasswordInputs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer$6, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "", children: "비밀번호 앞 2자리" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledInputWrap, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRefs[0],
...
function Button(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledButton, { ...props, children: props.text });
}
const StyledButtonContainer = dt.div`
  width: 100%;
  max-width: 539px;
  position: fixed;
  bottom: 0;
`;
const StyledEmpty = dt.div`
  width: 100%;
  height: 10px;
`;
var dist = {};
...
function CardSubmitButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledEmpty, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledButtonContainer, { onClick: submitCardInfo, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { text: "확인" }) })
  ] });
}
function useStep({ cardInfo, errorInfo }) {
  const stepRef = reactExports.useRef(0);
  const calculatedStep = reactExports.useMemo(() => {
...
function isCardNumberOk(cardNumber, cardNumberError) {
  return cardNumber.isFullFilled() && cardNumberError.isError() === false;
}
function isCardTypeOk(cardType) {
  return cardType.isFullFilled();
}
function isExpirationOk(expirationPeriod, year, month) {
  return expirationPeriod.isFullFilled() && year.isError() === false && month.isError() === false;
}
function isCVCNumberOk(CVCNumber, CVCError) {
  return CVCNumber.isFullFilled() && CVCError.isError() === false;
}
function isPasswordOk(password, passwordError) {
  return password.isFullFilled() && passwordError.isError() === false;
}
const StyledForm = dt.form`
  display: flex;
  flex-direction: column;
  gap: 3rem;
  width: 100%;
...
function getCardNumberValidationFns(length2, cardNumber) {
  return [
    { condition: () => cardNumber === INITIALIZE_VALUE, errorMsg: NO_ERROR },
    {
      condition: () => !isValidLength(cardNumber, length2),
      errorMsg: ERROR_MESSAGE$3.LENGTH
    },
    {
      condition: () => !isValidNumber(cardNumber),
      errorMsg: ERROR_MESSAGE$3.NUMBER
    }
  ];
}
function getCommonValidationFns(length2, date) {
  return [
    { condition: () => date === INITIALIZE_VALUE, errorMsg: NO_ERROR },
    {
      condition: () => !isValidLength(date, length2),
      errorMsg: ERROR_MESSAGE$2.LENGTH
    },
    {
      condition: () => !isValidNumber(date),
      errorMsg: ERROR_MESSAGE$2.NUMBER
    }
  ];
}
function getMonthValidationFns(length2, date) {
  return [
    { condition: () => date === INITIALIZE_VALUE, errorMsg: NO_ERROR },
    {
      condition: () => !isValidMonthRange(date),
      errorMsg: ERROR_MESSAGE$2.MONTH_RANGE
    },
    ...getCommonValidationFns(length2, date)
  ];
}
function getYearValidationFns(length2, date) {
  return [
    { condition: () => date === INITIALIZE_VALUE, errorMsg: NO_ERROR },
    {
      condition: () => !isValidYearRange(date),
      errorMsg: ERROR_MESSAGE$2.YEAR_RANGE
    },
    ...getCommonValidationFns(length2, date)
  ];
}
function getCVCValidationFns(length2, CVCNumber) {
  return [
    { condition: () => CVCNumber === INITIALIZE_VALUE, errorMsg: NO_ERROR },
    {
      condition: () => !isValidLength(CVCNumber, length2),
      errorMsg: ERROR_MESSAGE$1.LENGTH
    },
    {
      condition: () => !isValidNumber(CVCNumber),
      errorMsg: ERROR_MESSAGE$1.NUMBER
    }
  ];
}
const ERROR_MESSAGE = {
...
function getPasswordValidationFns(length2, password) {
  return [
    { condition: () => password === INITIALIZE_VALUE, errorMsg: NO_ERROR },
    {
      condition: () => !isValidLength(password, length2),
...
function CardInfoForm({
  ...
  const { cardNumberError, monthError, yearError, CVCError, passwordError } = useAllError();
  const cardInfo = {
    cardNumber,
    expirationPeriod,
    CVCNumber,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledForm, { children: [
    ...
    step >= 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(CardCVCNumberSection, { CVCNumber, CVCError }),
    ...
    step >= 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(CardTypeSection, { cardType }),
...
function useCardInfo(initialValues, maxLength) {
  const [values, setValues] = reactExports.useState(initialValues);
  function changeValues(type, data) {
    setValues((prev2) => ({
      ...prev2,
      [type]: data
    }));
...
function App() {
  const { cardNumber, expirationPeriod, CVCNumber, password, cardType } = useAllCardInfo();
...
function Complete() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./images/Check.svg", alt: "완료 이미지" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: forwardRootPage, text: "확인" })
  ] });
}
